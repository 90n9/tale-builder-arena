...
describe('DonatePage', () => {
  ...
  it('should render hero section', () => {
    ...
    expect(screen.getByText(donateContent.heroDescription)).toBeInTheDocument();
  ...
  it('should render thanks section', () => {
    ...
    expect(screen.getByText(donateContent.suggestedAmounts)).toBeInTheDocument();
    expect(screen.getByText(donateContent.suggestedNote)).toBeInTheDocument();
