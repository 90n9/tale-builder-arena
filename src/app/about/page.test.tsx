  ...
  it('should render mission and vision section', () => {
    expect(
      screen.getByRole('heading', {
        name: aboutContent.missionVision.heading, level: 2
      }),
    ).toBeInTheDocument()
    expect(
      screen.getByText(aboutContent.missionVision.missionTitle),
    ).toBeInTheDocument()
    expect(
      screen.getByText(aboutContent.missionVision.missionBody),
    ).toBeInTheDocument()
    expect(
      screen.getByText(aboutContent.missionVision.visionTitle),
    ).toBeInTheDocument()
    expect(
      screen.getByText(aboutContent.missionVision.visionBody),
    ).toBeInTheDocument()
  })
