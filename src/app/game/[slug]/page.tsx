...
const mockComments: MockComment[] = [
  {
    ...
    rating: 4.8,
    content:
      'เล่าเนื้อเรื่องลื่นมาก มีจังหวะลุ้นแบบต่อเนื่อง เหมาะให้เพื่อนลองเล่นรอบแรกก่อนเริ่มแคมเปญใหญ่',
...
const GameDetailPage = () => {
  ...
  const primaryCtaHref: `/game/${string}` = hasOngoingRun
    ? `/game/${slug}/play`
    : `/game/${slug}/init`;
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 pb-16 pt-20">
        <div className="container mx-auto max-w-6xl space-y-8">
          ...
          <Card className="ornate-corners relative overflow-hidden border-2 border-border bg-card/40 shadow-card">
            <div
            ...
            />
            <div
              className="absolute inset-0 bg-gradient-to-br from-background/95 via-background/85 to-background/60"
              aria-hidden
            />
            <CardContent className="relative z-10 space-y-6 p-8 md:p-10">
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-lg font-semibold text-secondary">{game.tagline}</p>
                  <p className="max-w-3xl leading-relaxed text-muted-foreground">
                    {game.description}
                  </p>
                </div>

                <div className="w-full space-y-4 md:w-auto md:min-w-[260px]">
          ...
          <div className="space-y-10">
            ...
            <div id="achievements" className="scroll-mt-24 space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {achievementsForGame.map((achievement) => {
                    ...
                    return (
                      <Card
                        key={achievement.id}
                        className={`border-2 ${isUnlocked
                          ? 'border-accent/50 bg-gradient-card'
                      ...
                      >
                        <CardContent className="space-y-3 p-5">
                          <div className="flex items-center gap-3">
                            <div
                              className={`rounded-lg p-3 ${isUnlocked ? 'bg-accent/20' : 'bg-muted/60'}`}
                            >
                              <Trophy
                                className={
                                  isUnlocked
            ...
            <div className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
              <Card className="ornate-corners border-2 border-border bg-card/70 shadow-card">
                <CardContent className="space-y-4 p-6">
                  ...
                  <form
                    ...
                    className="space-y-3 rounded-lg border border-border/50 bg-background/80 p-4"
                  >
              ...
              <Card className="border-2 border-accent/40 bg-gradient-card shadow-card">
                <CardContent className="space-y-4 p-6">
                  <div className="flex items-center gap-3">
                    <Star className="h-5 w-5 fill-accent text-secondary" />
                    <div>
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-5xl font-bold leading-none text-foreground">4.7</span>
                    <div className="space-y-1">
