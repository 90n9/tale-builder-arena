...
const game = {
  ...
  races: [
    {
      id: 'human',
      name: { th: 'มนุษย์', en: 'Human' },
      description: { th: 'คน', en: 'Human' },
      attribute_bonus: { str: 1 },
    },
  ],
  classes: [
    {
      id: 'warrior',
      name: { th: 'นักรบ', en: 'Warrior' },
      description: { th: 'ต่อสู้', en: 'Fighter' },
      starting_bonus: { agi: 2 },
    },
  ],
  backgrounds: [
    {
      id: 'noble',
      name: { th: 'ขุนนาง', en: 'Noble' },
      description: { th: 'สูงศักดิ์', en: 'Noble' },
      bonus_attributes: { str: 1 },
    },
  ],
  attributes: [
