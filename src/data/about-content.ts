...
export const aboutContent = {
  ...
  values: {
    ...
    bullets: [
      {
        title: "คลังเรื่องราวหลากหลาย",
        body: "พร้อมเล่นทันที ไม่ต้องสร้างเองหรือรอประมวลผล",
      },
      {
        title: "ตัวละคร & ภาพประกอบครบ",
        body: "ช่วยบรรยากาศของโลก เรื่อง และตัวละครชัดเจนตั้งแต่ต้น",
      },
      {
        title: "ระบบทางเลือกมีผลจริง",
        body: "ทุกการตัดสินใจส่งผลต่อเส้นเรื่องและตอนจบ กลับมาเล่นใหม่ก็เจอเส้นทางใหม่",
      },
      {
        title: "เข้าเล่นง่ายทุกที่",
        body: "เล่นผ่านเว็บเบราว์เซอร์ ทั้งมือถือและ PC ไม่ต้องดาวน์โหลด",
      },
    ],
  },
  missionVision: {
  ...
  team: {
    ...
    lead: "เราอาจเริ่มจากทีมเล็ก แต่ใจใหญ่ ทุกคนคือคนที่รักเรื่องราว รักเกม และเชื่อว่าจินตนาการควรเป็นของทุกคน",
  ...
  values: {
    heading: LocalizedText;
    lead: LocalizedText;
    bullets: Array<{ title: LocalizedText; body: LocalizedText }>;
  };
  missionVision: {
    heading: LocalizedText;
